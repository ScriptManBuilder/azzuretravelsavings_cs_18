      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Primary Descriptor:</strong> "DEALVIX" or "DLV*[Retail Service]"
              </LegalListItem>
              <LegalListItem>
                <strong>Alternative Descriptors:</strong> May include "AZZURE RETAIL" or retailer names for specific purchases
              </LegalListItem>
              <LegalListItem>
